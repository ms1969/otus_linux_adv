...
Подключаемся к web интерфейсу

![Image 363](lesson37/3.png)


Убеждаемся через web интерефейс, что пользователь создан при исполнении playbook 

![Image 363](lesson37/7.png)

Убеждаемся, что клиенты подключились к LDAP при исполнении playbook 

![Image 363](lesson37/8.png)


С помощью команды `kinit' на клиенте для созданного на сервере пользователя меняем пароль:

![Image 363](lesson37/5.png)
