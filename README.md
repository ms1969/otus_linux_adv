...
Убеждаемся, что на `inetRouter` активный интерфейс eth1 и включена опция активации `mac` адреса во время смены интерфеса.

![Image 362](lesson36/2.png)

Убеждаемся, что на `centralRouter` активный интерфейс eth1 и включена опция активации `mac` адреса во время смены интерфеса.

![Image 363](lesson36/3.png)

Выводим два окна с двух роутеров одновременно, запускаем ping c одного, на втором выключаем интерфейс и убеждаемся, что ping не пропал.
