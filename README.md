...
1. Клиевремя загрузки адрес и с помощью переданной опции сообщит адрес TFTP сервера.
2. Клиент с развернутого pxeсервера с помощью протокола TFTP забирает загрузчик и описания (меню) для дальнейшей загрузки.
