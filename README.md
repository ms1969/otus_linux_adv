...
2. Добавить еще один сервер `client2`, аналогичную `client1`
...
5. Завести в зоне newdns.lab запись
...
##### Описание стенда
Наш стенд после добовления секции для создания сервера `client2` состоит из 4 виртуальных машин:

● ns01 - Master DNS Server;

● ns02 - Slave DNS Server;

● client1 - 1-й сервер клиент
